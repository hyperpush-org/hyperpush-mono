...
When you want the public follow-on starters, branch to the generated Mesh repo examples instead of internal proof fixtures: [`examples/todo-postgres/README.md`](https://github.com/snowdamiz/mesh-lang/blob/main/examples/todo-postgres/README.md) is the serious shared/deployable PostgreSQL starter, [`examples/todo-sqlite/README.md`](https://github.com/snowdamiz/mesh-lang/blob/main/examples/todo-sqlite/README.md) is the honest local single-node SQLite starter, and [Production Backend Proof](https://meshlang.dev/docs/production-backend-proof/) is the maintainer-facing deeper backend handoff once those public starters stop being enough. That proof page keeps the public ladder scaffold/examples-first, then points repo maintainers to [`mesher/README.md`](https://github.com/snowdamiz/mesh-lang/blob/main/mesher/README.md) plus the named maintainer verifiers `bash scripts/verify-m051-s01.sh` and `bash scripts/verify-m051-s02.sh`.
...
mod tests {
    ...
    fn scaffold_clustered_project_writes_public_cluster_contract() {
        ...
        assert!(readme.contains("mesher/README.md"));
        assert!(readme.contains("bash scripts/verify-m051-s01.sh"));
        assert!(readme.contains("bash scripts/verify-m051-s02.sh"));
