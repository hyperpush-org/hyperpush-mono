...
- [ ] **T03: Recover abandoned `processing` jobs and classify failure state in health** `est:2h`
...
- [ ] **T04: Prove whole-process recovery and document the supervision contract** `est:90m`
