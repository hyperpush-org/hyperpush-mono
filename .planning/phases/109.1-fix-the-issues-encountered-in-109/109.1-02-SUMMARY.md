...
plan: 02
subsystem: codegen
tags: [llvm, inkwell, service-loop, type-coercion, bool, float, struct]

# Dependency graph
requires:
  - phase: 105.1-fix-the-issues-encountered-in-phase-105
    provides: "Service call codegen with coerce_to_i64 sender-side encoding"
provides:
...
affects: [service-codegen, mesher-rewrite]

# Tech tracking
tech-stack:
  added: []
  patterns: ["coerce_to_i64/decoerce inverse pattern for service message passing"]
